                ...
                <div className="row m-0 p-0 ">
                    ...
                    <div className=" col-lg-9 col-md-9 col-12 bg-white p-3 service_content">
                        ...
                        <div className="row m-0 p-0">
                            ...
                            <img effect="blur" src="./images/about/clean-science.webp" alt="" className="img-fluid" />
                            </div>
                            <div className="col-lg-7 col-12">
                                <div className="my-3" style={{ textAlign: "justify" }}>
                                    <p>Cleaning science technology refers to the use of technological chemicals, State of the art equipment, and advancements to save lives and prevent disease spread. In all of our cleaning methods, we use Nano Tech.</p>
                                </div>
                            </div>
                        </div>
                    </div>
