      ...
      <>
        <div className="container my-3 ">
          <div className="row m-0">
            ...
            <div className="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12 margin_top position-relative">
             <div className="cart-bill-data">
             <div className="card">
                <div className="card-body">
                ...
                <Link to={`/buy_now/${totalAmount.toFixed(2)}`} className="w-100">
                  <button className="place_order_btn my-3 w-100">PLACE ORDER</button>
                </Link>
             </div>
            </div>
          </div>
