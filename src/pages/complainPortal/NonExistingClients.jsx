...
function NonExistingClients() {
    ...
    const initialValue={ complain_type:null, name: "", phone: "", category: "", service: "", description: "" }
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="row mb-3">
                  <div className="col-lg-6 col-12">
                    <div className="complain-radio justify-content-end m-lg-3 mb-3">
                      <input type="radio" id="radio1" name="complain_type" value="Complaint of Fleet" onChange={handleChange}/>
                      <label htmlFor="radio1">Complaint of Fleet</label>
                    </div>
                  </div>
                  <div className="col-lg-6 col-12">
                    <div className="complain-radio m-lg-3 mb-3">
                      <input type="radio" id="radio2" name="complain_type" value="Complaint of Driver" onChange={handleChange}/>
